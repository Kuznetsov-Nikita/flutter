...
import 'package:homework_9/blocs/movie_bloc.dart';
import 'package:homework_9/blocs/movie_event.dart';
import 'package:homework_9/blocs/movie_state.dart';
                                    ...
                                    children: [
                                      ...
                                      Consumer<FavouriteMovies>(
                                        builder: (context, repo, _) {
                                          ...
                                          return IconButton(
                                            onPressed: () => hasMovie 
                                                ? repo.removeMovie(movieInfo) : repo.addMovie(movieInfo),
                                            icon: Icon(
