...
import 'package:homework_10/models/pages/movie_page.dart';
import 'package:homework_10/models/pages/movies_list_page.dart';

final Map<Type, Object Function(Map<String, dynamic>)> generatedMapping = {
  MoviePage: MoviePage.fromJson,
  Movie: Movie.fromJson,
  MoviesListPage: MoviesListPage.fromJson,
  MovieInfo: MovieInfo.fromJson,
};
